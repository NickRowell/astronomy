...
/**
 * This is the base class for interfaces to stellar evolutionary model sets that provide values
 * for the total pre-WD lifetime of a star as a function of mass and metallicity, and the inverse
 * quantity (stellar mass for a given metallicity and pre-WD lifetime).
 * 
 ...
 * @version $Id$
 */
public abstract class PreWdLifetime {

	/**
	 * The logger.
	 */
	protected static final Logger logger = Logger.getLogger(PreWdLifetime.class.getName());
	...
	/**
	 * Extending classes must implement the {@link PreWdLifetime#load()} method to populate the
	 * map on construction.
	 */
