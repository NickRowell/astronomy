...
/**
 * Definitions of various physical constants.
 *
 * @author nrowell
 * @version $Id$
 */
public class Physical {
	...
	/**
	 * The speed of light [ms^{-1}]
	 */
	public static double C = 299792458;
	
	/**
	 * The Planck constant [units?]
	 */
	public static double H = 6.626068E-34;
	
	/**
	 * The Boltzmann constant [units?]
	 */
	public static double Kb = 1.3806503E-23;
