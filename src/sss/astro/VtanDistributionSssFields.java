...
public class VtanDistributionSssFields
{
	
	/**
	 * Computes the fraction of stars along a given LOS wthat have a tangential
	 * velocity greater than the threshold.
	 * 
	 * @param velocityEllipsoid	Population velocity ellipsoid in Galactic coordinates [(km/s)^2]
	 * @param mean				Population mean velocity relative to LSR [km/s]
	 * @param solarMotion		Solar motion relative to LSR [km/s]
	 ...
	 * @param vtan				Tangential velocity thresold [km/s]
	 * @return
	 */
	public static double getDiscoveryFraction(Matrix velocityEllipsoid, Matrix mean, Matrix
			solarMotion, double ra, double dec, double vtan)
	{
	...
	public static void main(String args[]) throws IOException
	{
		...
		Matrix RTG = RTN.times(Galactic.r_E_G); //transformation from Galactic to Normal triad
		Matrix GTR = Galactic.r_G_E.times(NTR);
