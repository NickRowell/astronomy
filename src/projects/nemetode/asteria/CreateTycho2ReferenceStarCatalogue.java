 ...
 * @version $Id$
 */
public class CreateTycho2ReferenceStarCatalogue {

	/**
	 * The Logger
	 */
    protected static Logger logger = Logger.getLogger(CreateTycho2ReferenceStarCatalogue.class.getCanonicalName());
