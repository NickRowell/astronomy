...
public class Lam2015 {
	...
	private static void fig5Disk() throws IOException
	{
		...
		File outf = new File("/home/nrowell/Publications/In_preparation/Generalized_vmax_estimator/v_1/plots/fig5/thin_disk/differential_survey_volume.txt");
	...
	private static void fig5Spheroid() throws IOException
	{
		...
		double mu_min = 0.1;          	// Proper motion limits [arcsec/yr]
		double mu_max = 1.0;
		double vt_min = 200.0;			// Tangential velocity thresholds [km/s]
		double vt_max = Double.MAX_VALUE;
		double omega = 0.01;          	// Survey footprint size [steradians]. All-sky has omega = 4*pi.
		...
		File outf = new File("/home/nrowell/Publications/In_preparation/Generalized_vmax_estimator/v_1/plots/fig5/spheroid/differential_survey_volume.txt");
		BufferedWriter out = new BufferedWriter(new FileWriter(outf));
